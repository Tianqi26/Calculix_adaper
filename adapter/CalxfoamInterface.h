...
#ifndef CalxfoamINTERFACE_H
#define CalxfoamINTERFACE_H
 ...
 */
typedef struct CalxfoamInterface {
...
typedef struct CalcSimulationData {
	...
	// Interfaces
	int numCalxfoamInterfaces;
	CalxfoamInterface ** CalxfoamInterfaces;
...
//! read interfaceData
/*
void Cacfoam_ReadCouplingData( SimulationData * sim );
/*
!Read force from file
*/
// void ReadNodeForces( ITG * nodes, double * forces, ITG numNodes, int * xforcIndices);
